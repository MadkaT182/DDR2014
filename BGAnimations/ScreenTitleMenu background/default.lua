return Def.ActorFrame{
	...
	LoadActor( "DDR2013_logo" )..{
	    InitCommand=cmd(x,SCREEN_CENTER_X-6;y,SCREEN_CENTER_Y-38;zoom,2;),
		OnCommand=cmd(diffusealpha,0;sleep,0.25;linear,0.6;zoom,1;diffusealpha,1;sleep,1);
	};

	LoadActor( "DDR2013_logo" )..{
		InitCommand=cmd(x,SCREEN_CENTER_X-6;y,SCREEN_CENTER_Y-38;),
	...
	LoadActor( "DDR2013_Blend" )..{
		InitCommand=cmd(zoom,1;x,SCREEN_CENTER_X-6;y,SCREEN_CENTER_Y-37);
...
-- Soustitre
	LoadActor( "konami_copyright" )..{
		OnCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y+207;sleep,0.916;linear,0.4);
	};
	-- eamusement titre --
    LoadActor( "eam2" )..{
